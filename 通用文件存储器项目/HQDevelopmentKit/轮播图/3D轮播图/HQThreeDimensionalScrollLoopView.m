//
//  HQThreeDimensionalScrollLoopView.m
//  通用文件存储器项目
//
...
@interface HQThreeDimensionalScrollLoopView ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate>
...
@implementation HQThreeDimensionalScrollLoopView
